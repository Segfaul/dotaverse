...
from backend.api.model import Team
from backend.api.schema import TeamSchema, PartialTeamSchema, TeamResponse
...
async def read_team(
    ...
    team = await get_object_or_raise_404(
        ...
        include_players=include_players, include_matchteams=include_matchteams
    )
