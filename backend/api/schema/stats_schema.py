...
class IndependentPlayerHeroChanceStatsSchema(IndependentPlayerHeroChanceSchema):
    """
...
class IndependentMatchPlayerStatsSchema(IndependentMatchPlayerSchema):
    """
...
class MatchPlayerStatsSchema(IndependentMatchPlayerStatsSchema):
    """
    Pydantic schema for MatchPlayer table data (big queries).
    ...
    player_hero_chance: Optional[IndependentPlayerHeroChanceStatsSchema] = None


class PlayerHeroChanceStatsSchema(IndependentPlayerHeroChanceStatsSchema):
    """
    Pydantic schema for PlayerHeroChance table data (big queries).
    ...
    """
    player: Optional[IndependentPlayerSchema] = None
    match_players: Optional[List[IndependentMatchPlayerStatsSchema]] = None


class IndependentHeroStatsSchema(IndependentHeroSchema):
    """
    Pydantic schema for Hero table data (big queries).
    ...
    """
    player_hero_chances: List[Optional[PlayerHeroChanceStatsSchema]] = None
...
class IndependentPlayerStatsSchema(IndependentPlayerSchema):
    ...
    """
    player_hero_chances: Optional[List[IndependentPlayerHeroChanceStatsSchema]] = None


class IndependentTeamPlayerStatsSchema(IndependentTeamPlayerSchema):
    """
...
class TeamPlayerStatsSchema(IndependentTeamPlayerStatsSchema):
    """
    Pydantic schema for Player table data.
...
class PlayerStatsSchema(IndependentPlayerStatsSchema):
    ...
    """
    match_players: Optional[List[MatchPlayerStatsSchema]] = None
    team_players: Optional[List[IndependentTeamPlayerStatsSchema]] = None
