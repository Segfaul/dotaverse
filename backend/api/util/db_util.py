...
from backend.api.util.endpoint_util import create_object_or_raise_400, update_object_or_raise_400
...
async def get_or_create(db_session: AsyncSession, item, defaults: dict = None, **kwargs):
    ...
    Also updates the instance with defaults `defaults` param
    """
